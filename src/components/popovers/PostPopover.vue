...
import MenuTickerDeleteCustomBookmark from "@/components/next/CustomBookmark/DeleteCustomBookmark.vue"
...
import MenuTickerOpenCustomBookmarkManagementPopup from "@/components/next/CustomBookmark/OpenCustomBookmarkManagementPopup.vue"
...
<template>
  ...
  >
    ...
    >
      ...
      <!-- フィードインタラクション -->
      <template v-if="feedAcceptsInteractions === true && feedGeneratorDid != null">
