export default () => ({
  ...
  "starterPackSearch": "スターターパックを見つける",
  "keyword": "キーワード",
  ...
  "videoPreload": "動画の先読み",
  "videoQuality": "動画の画質",
  "videoQualityHigh": "画質優先",
  "videoQualityAuto": "速度優先",
  ...
  "bot": "自動化アカウント",
  "bot-description": "ボットなどプログラムによって運用されるアカウント",
  ...
  "reportSendChatConvo": "チャットをレポートする",
  ...
  "listUserNotFoundInList": "このユーザーはこのリストに含まれていません。",
  "listUserAlreadyInList": "このユーザーはすでにこのリストに含まれています。",
  "listMuted": "ミュート中",
  "listMuting": "リストミュート中",
  "listBlocked": "ブロック中",
  ...
  "chatSystemMessageGroupNameChanged": "グループ名が変更されました:",
  ...
  "chatLockStatus-unlocked": "ロックなし",
  "chatLockStatus-locked": "ロック中",
  "chatLockStatus-locked-permanently": "恒久的にロック中",
  ...
  "otherFolding": "その他の折り畳み",
  "otherFolding1": "自動化アカウントによるポスト",
