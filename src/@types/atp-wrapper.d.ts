interface TIAtpWrapper {
  ...
  fetchTimeline (this: TIAtpWrapper, oldFeeds: Array<TTFeed>, replyFolding?: string, repostFolding?: string, limit?: number, cursor?: string, middle?: boolean): Promise<undefined | false | string>
