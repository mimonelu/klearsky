...
import CustomBookmarkPopup from "@/components/next/CustomBookmark/CustomBookmarkPopup.vue"
import CustomBookmarkManagementPopup from "@/components/next/CustomBookmark/CustomBookmarkManagementPopup.vue"
...
import LabelerListPopup from "@/components/next/Labeler/LabelerListPopup.vue"
import LabelerSettingsPopup from "@/components/next/Labeler/LabelerSettingsPopup.vue"
import LikeUsersPopup from "@/components/popups/LikeUsersPopup.vue"
import ListCardPopover from "@/components/next/List/ListCardPopover.vue"
import ListEditPopup from "@/components/next/List/ListEditPopup.vue"
import ListUserManagementPopup from "@/components/next/List/ListUserManagementPopup.vue"
...
import MyListPopup from "@/components/next/List/MyListPopup.vue"
...
import SendChatConvoReportPopup from "@/components/next/Report/SendChatConvoReportPopup.vue"
...
<template>
  ...
  >
    ...
    <div class="popup-container">
      ...
      <!-- チャットルームレポート送信ポップアップ -->
      <Transition>
        <SendChatConvoReportPopup
          v-if="state.sendChatConvoReportPopupProps.display"
          :myConvo="state.sendChatConvoReportPopupProps.myConvo as TIMyConvo"
          @close="state.closeSendChatConvoReportPopup"
        />
      </Transition>
